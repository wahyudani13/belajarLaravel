...
<div class="container-fluid">
    ...
    <form action="/pegawai/{{$data->id}}" method="post">
        ...
        <div class="row mb-3">
            ...
            <input type="text" class="form-control" id="jabatan" name="jabatan" placeholder="Jabatan Pegawai" value="{{ old('jabatan', $data->jabatan) }}">
            @error('jabatan')
        ...
        <div class="row mb-3">
            ...
            <input type="email" class="form-control" id="email" name="email" placeholder="Usia Pegawai" value="{{ old('email', $data->email) }}">
            @error('email')
