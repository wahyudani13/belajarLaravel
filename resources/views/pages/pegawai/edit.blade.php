...
<div class="container-fluid">
    ...
    <form action="/pegawai/{{$data->id}}" method="post">
        ...
        <div class="row mb-3">
            ...
            <input type="text" class="form-control" id="nama_pegawai" name="nama_pegawai" placeholder="Nama Pegawai" value="{{ old('nama_pegawai', $data->nama_pegawai) }}">
            @error('nama_pegawai')
        ...
        <div class="row mb-3">
            ...
            <input type="text" class="form-control" id="jabatan_pegawai" name="jabatan_pegawai" placeholder="Jabatan Pegawai" value="{{ old('jabatan_pegawai', $data->jabatan_pegawai) }}">
        ...
        <div class="row mb-3">
            ...
            <input type="number" class="form-control" id="usia_pegawai" name="usia_pegawai" placeholder="Usia Pegawai" value="{{ old('usia_pegawai', $data->usia_pegawai) }}">
            @error('usia_pegawai')
        ...
        <div class="row mb-3">
            ...
            <textarea class="form-control" id="alamat_pegawai" name="alamat_pegawai" rows="3" placeholder="Alamat Pegawai">{{ old('alamat_pegawai', $data->alamat_pegawai) }}</textarea>
